...
- Observe the behavior and response for each WAF paranoia level setting different attacks or payloads , disabling rules or using the default config in a quick way.
- The PoC below provide de basic configuration and re-use byself the current WAF deployed by settting a basic "Mock" and simulate the backend.
...
__  _  _______   _/ ____\______  _____   _______ _____     ____  \   _  \  /_   |  __| _/\_____  \ 
\ \/ \/ /\__  \  \   __\ \____ \ \__  \  \_  __ \\__  \   /    \ /  /_\  \  |   | / __ |   _(__  < 
 \     /  / __ \_ |  |   |  |_> > / __ \_ |  | \/ / __ \_|   |  \\  \_/   \ |   |/ /_/ |  /       \
  \/\_/  (____  / |__|   |   __/ (____  / |__|   (____  /|___|  / \_____  / |___|\____ | /______  /
              \/         |__|         \/              \/      \/        \/            \/        \/ 
